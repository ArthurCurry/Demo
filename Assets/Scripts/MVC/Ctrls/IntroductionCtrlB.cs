...
public class IntroductionCtrlB : MonoBehaviour
{
    ...
    void Init()
    {
        Introduction p1 = new Introduction("基本的操作", "玩家可以通过WASD控制行走，每次只能行动一格。经过重重阻碍到达游戏目的地即视为成功通关。", "第一关 基本操作");
        Introduction p2 = new Introduction("敌人·其一", "每一名敌人都有着自己的攻击范围，一旦被攻击到即判定死亡。", "第一关 敌人");
        Introduction p3 = new Introduction("敌人·其二", "敌人的机关的行动回合取决于玩家，即玩家每进行一次行走操作，敌人也会按照设定路径进行一次行走操作，否则将处于静止状态。", "第一关 敌人");
        Introduction p4 = new Introduction("攻击机关", "眼球机关的攻击范围为面前五格。玩家每进行一次行走操作，机关则会顺时针转90度，否则将处于静止状态。", "第二关  机关");
        Introduction p5 = new Introduction("收集道具·其一", "地图中充满着各种各样的收集道具。", "第二关 收集");
        Introduction p6 = new Introduction("收集道具·其二", "这些道具包含着女孩高三一年的往事，有助于玩家更好地理解游戏剧情。", "第二关 收集");
        Introduction p7 = new Introduction("同步敌人", "在前方的敌人是同步敌人，其每一步都会模仿主角的行动。", "第三关  同步");
        Introduction p8 = new Introduction("触发机关·其一", "这种有不详气息的机关无法由玩家进行操纵，必须诱导敌人踏上此机关以触发事件。", "第三关 机关");
        Introduction p9 = new Introduction("地图碎片·其一", "在红线框定的范围内，会给予玩家特定的物件——地图碎片。可以拖拽放置地图碎片，将异常的地面（包括无法行走的地面，坍塌地面，冰面）变成能够正常行走的地面。", "第三关 地图碎片");
        Introduction p10 = new Introduction("地图碎片·其二", "请注意，地图碎片只对红线内地图有效。进入红线区域地图碎片会出现，一旦走出即会消失。", "第三关 地图碎片");
        Introduction p11 = new Introduction("冰面", "无论是玩家还是敌人，在冰面上面都会滑行，直到遇到阻碍或者正常路面。滑行只算做一步操作。", "第四关 冰面");
        Introduction p12 = new Introduction("触发机关·其二", "这种正常的机关可以由玩家进行触碰，并且触发相应的事件。", "第五关 机关");
        Introduction p13 = new Introduction("异步敌人", "在前方的敌人是异步敌人，其每一步都会与主角的行动相反。", "第六关 异步");
        Introduction p14 = new Introduction("传送门", "在传送门上面按E键，即可传送到另一相同颜色的传送门。", "第七关 传送门");
