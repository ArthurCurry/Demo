...
public class BagModel : UIModel
{
    ...
    private void Load()
    {
        ...
        Collector w1 = new Collector(11, "报纸——9月21日（1）", "据本报记者报道，A，B市的高考政策改革已经对本市的教育环境发起了极大的冲击。今天早上，有大量的学生以及家长自发地组成了团体，在市教育局面前举旗抗议，为了避免引发大规模冲突，已经被警察镇压。但截至目前为止，本市教育局尚未有任何表态。", "bag newspaper");

        Collector w2 = new Collector(12, "报纸——9月21日（2）", "根据进一步采访，记者了解到广大的学生及家长都对本省持续已久的应试教育感到不满，而临省的改革正好成了这次联合抗议的导火线。据悉，以第一中学为首的本省教育联盟也向教育局提出了改革建议。", "bag newspaper");
        ...
        Collector w7 = new Collector(24, "隔壁班某同学A的奖状", "热烈祝贺高二（三）班的晨晨同学在第十七届校园诗词朗诵比赛中取得一等奖，特发此证，以资鼓励。", "jiang zhuang");
        ...
        Collector w9 = new Collector(31, "一摞厚厚的已用的游戏点卡", "铁索已断，山河将倾，新战争资料片上线！现充值100元得双倍钻石！", "youxika");
        ...
        Collector w17 = new Collector(51, "报纸——9月25日（1）", "据记者报道，目前学区房的价格持续攀升。以目前风头正盛的一中为例，附近的核心区域房价已经飙升至6万/平方以上，专家表示这种热潮是违背市场正常发展的表现。", "bag newspaper");

        Collector w18 = new Collector(52, "一个破旧的小熊玩偶", "一个破旧的小熊玩偶，反面刻着“小玉”两个字，正面则是刻着“晨晨”，看起来像是两个小姑娘年幼时友情的印证。", "doll");

        Collector w19 = new Collector(53, "报纸——9月25日（2）", "根据记者卧底调查，发现许多学校老师均有私自在外上课的情况。这种情况屡见不鲜，也可以理解，政府和学校也往往睁一只眼闭一只眼。但是与教育机构的老师套话得知：很多老师完全疏于学校中的教育，上课一切从简，也从不开设答疑，却经常暗示学生去教育机构上他的课，以此牟利。目前这种情况还在调查中，欢迎关注后续。", "bag newspaper");

        Collector w20 = new Collector(61, "社区通知", "为了提高居民生活安全感，现执行一人一卡制度，晚上10点钟之后将会有社区门禁。小区居民必须刷卡才能进入。", "bag tongzhi");

        Collector w21 = new Collector(62, "掉落在地上的小广告", "由第一中学的特级英语教师——方老师开设的辅导班已经正式开启。先报名即可享受跳楼价200元/小时。课堂仅限50人，报名从速。", "4.bag tongzhi");//美术素材还没好

        Collector w22 = new Collector(63, "一个空的酒瓶", "酒精含量70%，目测是女孩父亲喝完扔掉的酒瓶，毕竟喝这么烈的酒的人很少。", "jiuping");
